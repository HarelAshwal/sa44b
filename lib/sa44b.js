...
class Sa44b {
    ...
    GetSweep_32f(size) {
        var min = Buffer.alloc(size * 4);
        var max = Buffer.alloc(size * 4);
        ...
        //     console.log(i);
        //     min_float.push(Buffer.from(min, i * 4, 4).readFloatLE(0));
        //     max_float.push(Buffer.from(max, i * 4, 4).readFloatLE(0));
        // }
        return {
            min: min,
            max: max
